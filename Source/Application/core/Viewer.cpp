...
void Viewer::deleteGraph( const int handle ) const {
	DeleteGraph( handle );
}
...
void Viewer::drawPolygonFloor( const Vector& pos, int id ) const {
	...
	DrawPolygon3D( vertex, 2, id, TRUE );
}
...
void Viewer::drawPolygonWall( const Vector& pos, int id, int id_2 ) const {
	...
	*/
	...
	// 天井
	DrawPolygon3D( vertex_1, 2, id, TRUE );
	// 壁：手前
	DrawPolygon3D( vertex_2, 2, id_2, TRUE );
	// 壁：右
	DrawPolygon3D( vertex_3, 2, id_2, TRUE );
	// 壁：左
	DrawPolygon3D( vertex_4, 2, id_2, TRUE );
}
